...
public class PokemonSample {
    ...
    public static Pokemon initiateBulbizarre() {
        ...
        return new Pokemon("bulbasaur", 31, 31, 18, 18, 23, 23, 17, Type.grass, bulbizarreMoves);
    }
    ...
    public static Pokemon initiatePikachu() {
        ...
        return new Pokemon("pikachu", 29, 29, 20, 16, 19, 19, 28, Type.electric, pikachuMoves);
    }

    public static Pokemon initiateCarapuce() {
        if (!carapuceMoves.contains(attacks.get(5))) carapuceMoves.add(attacks.get(5)); // Water Gun

        return new Pokemon("squirtle", 31, 31, 17, 23, 19, 22, 17, Type.water, carapuceMoves);
    }
    ...
    public static Pokemon initiateSalameche() {
        ...
        return new Pokemon("charmander", 30, 30, 19, 17, 22, 19, 21, Type.fire, salamecheMoves);
    }
    ...
    public static Pokemon initiatePidgey() {
        ...
        return new Pokemon("pidgey", 30, 30, 21, 19, 16, 16, 26, Type.flying, pidgeyMoves);
    }
    ...
    public static Pokemon initiateButterfree() {
        ...
        return new Pokemon("butterfree", 35, 35, 16, 17, 25, 23, 21, Type.bug, butterfreeMoves);
    }
    ...
    public static Pokemon initiateEkans() {
        ...
        return new Pokemon("ekans", 34, 34, 21, 17, 16, 20, 24, Type.poison, ekansMoves);
    }
}
