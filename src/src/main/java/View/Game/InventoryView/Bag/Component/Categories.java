...
import static View.Game.FightView.FightView.npcPokemon;
import static View.Game.FightView.FightView.playerPokemon;
                    ...
                    if (chosenPokemon.getHP() < chosenPokemon.getMaxHP()) {
                        ...
                        executor.executeNext(() -> {
                            if (npcPokemon.getStatus() != Status.KO) {
                                ...
                                executor.addEvent(new AttackEvent(npcPokemon, playerPokemon, npcMove, FightView.getTerrain(), textBubble, FightView.getPlayerBar(), executor));
                            } else {
