...
public class SwitchView extends BorderPane implements View {
    ...
    public SwitchView(Trainer player, Trainer agent, TextBubble textBubble, Runnable onClose) {
        this.player = player;
        this.agent = agent;
    ...
    protected void handleSwitch(Pokemon pokemon) throws IOException {
        ...
        executor.addEvent(new StartTurn(agent, player, pokemon, executor));
