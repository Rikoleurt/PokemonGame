...
import View.GameView.Inventory.Bag.BagView;
import Utils.SceneManager;

import View.GameView.Switch.SwitchView;
...
public class BattleButtons extends HBox {
    ...
    private void onButtonPressed(Move move, Field field) throws IOException {
        ...
        executor.addEvent(new StartTurn(opponent, player, move, field, executor, this));
